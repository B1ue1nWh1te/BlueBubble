				...
				<?php if ($this->allow('comment')) : ?>
					<div id="<?php $this->respondId(); ?>" class="comment-reply">
						...
						<form method="post" action="<?php $this->commentUrl() ?>" id="comment-form" role="form" class="container" style="overflow: auto; zoom: 1;">
									...
									<div class="col-md-4">
										<div class="form-group">
											<div class="input-group mb-4">
												...
												<input type="text" name="author" id="author" class="form-control" placeholder="昵称(必填 便于回复)" value="<?php $this->remember('author'); ?>" required />
											</div>
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<div class="input-group mb-4">
												...
												<input type="email" name="mail" id="mail" class="form-control" placeholder="邮箱(非必填)" value="<?php $this->remember('mail'); ?>" <?php if ($this->options->commentsRequireMail) : ?> required<?php endif; ?> />
											</div>
										</div>
									</div>
								</div>
							<?php endif; ?>
							<p>
								<textarea rows="8" cols="50" name="text" id="textarea" class="form-control" required placeholder="(评论审核通过后才会展示)"><?php $this->remember('text'); ?></textarea>
							</p>
							<p>
								<button type="submit" class="btn btn-outline-success" id="add-comment-button" style="float: right;"><?php _e('提交留言'); ?></button>
							</p>
						</form>
					</div>
				<?php else : ?>
